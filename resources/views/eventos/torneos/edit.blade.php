        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><i class="fas fa-edit mr-2"></i>Editar Torneo</li>
                </ol>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="descripcion" id="descripcion" class="form-control" rows="7" style="resize: none;"
                                                value="{{ $torneo->descripcion }}">{{ $torneo->descripcion }}</textarea>
                                            ...
                                            <select name="ligas_id" id="ligas_id" class="form-control">
                                                ...
                                                @foreach ($ligas as $liga)
                                                    <option value="{{ $liga->id }}"
                                                        {{ $liga->id == $torneo->ligas_id ? 'selected' : '' }}>
                                                        {{ $liga->nombre }}</option>
                                                @endforeach
                                            </select>
                                        </div>
