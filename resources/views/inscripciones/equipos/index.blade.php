        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><i class="fas fa-users mr-2"></i>Equipos</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-11">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-text"><b> PANEL DE EQUIPOS</b></h3>
                        <div class="card-body">
                            <h5 class="m-0 float-left">
                                ...
                                <a href="{{ route('generar.pdf.equipos') }}" class="btn btn-danger">
                                    <i class="fas fa-file-pdf"></i> PDF</a>
                            </h5>
                            <form action="{{ route('equipos.index') }}" method="GET" class=" form-inline justify-content-end">
                                @csrf
                                        ...
                                        @else
                                            @foreach ($equipos as $equipo)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @can('editar-equipo')
                                                            <a href="{{ route('equipos.edit', $equipo->id) }}"
                                                                class="btn btn-warning btn-sm" title="Editar equipo">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        @endcan
                                                        @can('ver-equipo')
                                                            <a href="{{route('equipos.show',$equipo->id)}}"
                                                                class="btn btn-info btn-sm" title="Ver equipo">
                                                    ...
                                                    {{-- @include('inscripciones.equipos.modal.edit') --}}
...
@section('js')
    ...
    @if (session('create') == 'El equipo se creo con exito')
        <script>
            Swal.fire(
                'Registrado!',
    ...
    @if (session('update') == 'El equipo se actualizo con exito')
    ...
    <script>
        $('.formulario-eliminar').submit(function(e) {
            ...
            Swal.fire({
                title: '¿Está seguro?',
                text: "¡Desea cambiar el estado de la equipo!",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        '¡Cambiado!',
                        'El estado de la equipo ha sido cambiado.',
                        'success'
                    )
                    this.submit();
                }
